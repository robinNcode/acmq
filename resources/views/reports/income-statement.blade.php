...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ route('reports.income-statement.print', request()->query()) }}" target="_blank" title="Print report" class="p-2 bg-green-600 hover:bg-green-700 text-white rounded-lg">
